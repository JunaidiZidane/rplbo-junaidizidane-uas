...
<html lang="en">
  ...
  <head>
    ...
    <title>E-Mobillindo Junaidi Jaya Motor</title>
  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg bg-dark fixed-top">
        <div class="container">
          <a class="navbar-brand" href="#"><h2>E-Mobillindo | JJM</h2></a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url('customer/data_mobil') ?>">Daftar Mobil</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Pesanan</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">Info Mobil</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url('auth/logout'); ?>">Welcome<span> | Logout</span></a>
              </li>
              <?php }
              else{ ?>
              <li class="nav-item">
