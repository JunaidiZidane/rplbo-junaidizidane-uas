            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <select name="power_s" id="" class="form-control">
                  <option <?php if($mb->power_s == "1"){echo "selected='selected'";} echo $mb->power_s; ?> value="1">Tersedia</option>
                  <option <?php if($mb->power_s == "0"){echo "selected='selected'";} echo $mb->power_s; ?> value="0">Tidak Tersedia</option>
                </select>
