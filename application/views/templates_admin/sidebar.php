      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?= base_url('admin/dashboard'); ?>">E-Mobillindo | JJM</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?= base_url('admin/dashboard'); ?>">JJM</a>
          </div>
          <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="<?= base_url('admin/transaksi'); ?>"><i class="fas fa-random"></i> <span>Data Order</span></a></li>

            <li><a class="# ?>"><i class="fas fa-clipboard-list"></i> <span>Laporan</span></a></li>
