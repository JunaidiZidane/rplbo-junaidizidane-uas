          ...
          <div class="blog-post">
            ...
            <div class="down-content">
              ...
              <div class="row">
                ...
                <?php if($mb->power_s == '1'){ ?>
                  <a href="#" class="badge badge-success m-1"><i class="fa fa-check-square"></i> Power Sterring</a>
                  <?php } 
                else{ ?>
                  <a href="#" class="badge badge-danger m-1"><i class="fa fa-times-circle"></i> Power Sterring</a>
                <?php } ?>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <ul class="post-tags">
                      ...
                      <?php 
                      if($mb->status == "1"){ ?>
                        <a href="<?= base_url('customer/rental/tambah_rental/'.$mb->id_mobil) ?>"> Pesan Mobil</a></li>
                      <?php }
                      else{ ?>
                        <a href="#" style="color: black;"> Tidak Tersedia</a></li>
                      <?php } ?>
                      
                      <li><a href="<?= base_url('customer/data_mobil/detail_mobil/'.$mb->id_mobil) ?>"> | Detail Mobil</a></li>
                    </ul>
                  </div>
                </div>
              </div>
