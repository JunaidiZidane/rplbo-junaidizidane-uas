        ...
        <div class="col-md-4 col-sm-6">
          <div class="blog-post">
            ...
            <div class="down-content">
              <strong>Mulai</strong> <span> 200jt</span>
              <a href="#"><h4>Mobil Sport</h4></a>
              <p>Mobil yang sangat nyaman digunakan untuk bersantai dan lainya.</p>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="main-content">
          <div class="row">
            <div class="col-lg-8">
              <span>E-Mobillindo Junaidi Jaya Motor</span>
              <h4>Tempat mencari mobil bekas berkualitas dan mantap.</h4>
            </div>
            <div class="col-lg-4">
    ...
    <div class="all-blog-posts">
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6">
          <div class="blog-post">
            <div class="blog-thumb">
              <img src="<?= base_url('assets/assets_shop') ?>/images/blog-1-720x480.jpg" alt="">
            </div>
            <div class="down-content">
        ...
        <div class="col-md-4 col-sm-6">
          <div class="blog-post">
            <div class="blog-thumb">
              <img src="<?= base_url('assets/assets_shop') ?>/images/blog-2-720x480.jpg" alt="">
            </div>
            <div class="down-content">
              <a href="blog-details.html"><h4>Lorem ipsum dolor sit amet, consectetur adipisicing elit</h4></a>
        ...
        <div class="col-md-4 col-sm-6">
          <div class="blog-post">
            <div class="blog-thumb">
              <img src="<?= base_url('assets/assets_shop') ?>/images/blog-3-720x480.jpg" alt="">
            </div>
            <div class="down-content">
              <a href="blog-details.html"><h4>Lorem ipsum dolor sit amet, consectetur adipisicing elit</h4></a>
